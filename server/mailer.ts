    ...
    async registerMail(
        ...
        <div style="max-width: 600px; margin: 20px auto; background-color: #081043; padding: 30px; border-radius: 10px; border: 4px solid #081043;">
            <div style="text-align: center;">
                    <a href="https://ibb.co/g9SP8mx"><img src="https://iili.io/3cQsJQS.png" alt="Logo Aleargă pentru Viață" style="max-width: 75%; height: auto; display: inline-block; box-shadow: 0 0 20px rgba(0, 0, 0, 0.3);"></a>
            </div>
