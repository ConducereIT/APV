...
const CurseComponent: React.FC<CurseValide> = ({ interfata}): JSX.Element => {
    ...
    const { cursa, oraStart, distanta, donatieMinima, descriere, urlHarta } = interfata || {};
                ...
                interfata && (
                    <div className="relative cursor-default">
                        ...
                        <div className="mt-10 h-[30rem] ml-1 w-1/2 ">
                            <iframe src={`${urlHarta}`} loading="lazy" className="border-0 h-full w-full" title={`${cursa}`} ></iframe>
                        </div>
        ...
        <div className="md:hidden block ml-8 pt-5 ">
            {
                interfata && (
                    <div className="relative cursor-default ">
                        <h1 className="text-center -ml-[20%] text-2xl font-bolt mt-4"> <span className="font-normal font-source-code-pro text-2xl">Cursa - </span> {cursa}</h1>
                        <h1 className="hover:text-[#A8A5BF] mt-10 font-bold -ml-2">Informatii Cursa:</h1>
                        ...
                        <h1 className="hover:text-[#A8A5BF] -ml-2 mt-10 leading-7">{descriere}</h1>

                        <h1 className="mt-12 -ml-2"><span>Vezi mai jos harta traseului!</span></h1>

                        <h1 className="font-bolt text-lg mt-8 -ml-2"><span className="font-normal">Pentru mai multe informații consultați </span> regulamentul <span className="font-normal"> ! </span> </h1>
