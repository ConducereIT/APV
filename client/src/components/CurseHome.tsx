...
export default function CurseHome() {
  ...
  return (
    <div className='w-full px-[var(--bs-gutter-x,.75rem)]   bg-customBackground relative '>
        <img src={flyingImg4} className='absolute top-0 right-0 h-full md:w-1/2 lg:w-1/3 xl:w-1/4 z-0' alt='Imagine de fundal' ></img> 
    <div className="container  md:pt-64 md:pl-64 md:pr-64 relative z-10">
        ...
        <div className="md:flex md:items-center justify-center">
                ...
                <div className="md:w-1/4 mb-4 md:mb-0 md:mr-4 overflow-x-auto">
                    <div className="flex sm:flex-row md:flex-col">
                        <button
                        className="bg-[#006470] hover:bg-teal-500  rounded-md md:text-right sm:text-center lg:px-35 lg:py-33 md:px-20 md:py-20 sm:px-8 sm:py-15 ${selectedCategory === 'All for one' ? 'bg-blue-500' : ''}"
                        ...
                        <button
                        className="bg-[#006470] hover:bg-teal-500  rounded-md md:text-right sm:text-center lg:px-35 lg:py-33 md:px-20 md:py-20 sm:px-8 sm:py-15"
                ...
                <div className="md:w-3/4 border-4 border-white">
