...
export default function CurseHome() {
  ...
  const [allForOneText1, setAllForOneText1] = useState(
  ...
  const [allForOneText2, setAllForOneText2] = useState(
    "Tocmai în spiritul caritabil din care s-a și născut Aleargă Pentru Viață, participanții sunt încurajați să ofere drept donație pentru Florin cât consideră."
  );
  ...
  const handleCategoryChange = (category: string) => {
    ...
    switch (category) {
      case "All for one":
        ...
        setMinimumDonation("Donatie minima: OPŢIONAL");
        setAllForOneText1(
          "Cursa All For One este o tură populară, necompetitivă, perfectă pentru cei care vor să facă mișcare în natură pe o distanță accesibilă. Aceasta se adresează tuturor persoanelor, de orice vârstă sau gen, chiar și persoanelor cu dizabilități."
        );
        setAllForOneText2(
      ...
      case "Fete":
        ...
        setMinimumDonation("Donatie minima: 20 RON");
        setMapSrc(
          "https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2848.878166115072!2d26.051764615851956!3d44.43970637910117!2m3!1f0!2f0!3f0!3m2!1d44.43998527916441!2d26.051764615851956!4f0!5f0.7820865974627469"
        );
        break;
      case "Băieți":
  ...
  return (
    <div className="w-full px-[var(--bs-gutter-x,.75rem)]   bg-customBackground  ">
      ...
      <div className="flex justify-center ">
        <div className="container  md:pt-44  lg:px-32 mx-auto  justify-center">
          <h1 className="lg:text-52 text-36 font-bold text-center mb-8 text-black">
            CURSE
          </h1>
          <div className="md:flex md:items-center  justify-center">
            <div className="md:w-1/4 mb-4 md:mb-0 md:mr-4 overflow-x-auto">
              <div className="flex sm:flex-row md:flex-col">
                <button
                  className="bg-[#006470] hover:bg-teal-500  rounded-md md:text-right sm:text-center lg:px-35 lg:py-33 md:px-20 md:py-20 px-33 py-8 ${selectedCategory === 'All for one' ? 'bg-blue-500' : ''}"
                  onClick={() => handleCategoryChange("All for one")}
                >
                  <span className="font-bold lg:text-24 md:text-20 sm:text-20 text-white  whitespace-nowrap">
                    ALL FOR ONE
                  </span>
                  <br />
                  <span className="lg:text-16 md:text-14 text-white ">
                    TOATE VÂRSTELE
                  </span>
                </button>
                <button
                  className="bg-[#006470] hover:bg-teal-500  rounded-md md:text-right sm:text-center lg:px-35 lg:py-33 md:px-20 md:py-20 px-33 py-15"
                ...
                >
                  ...
                  <br />
                  <span className="lg:text-16 md:text-14 text-white whitespace-nowrap">
                    &lt; 10 ANI
                  </span>
                </button>
                <button
            ...
            <div className="md:w-3/4 border-4 border-white pr-8 pb-15">
              <div className="text-left">
                ...
                <p className="event-info md:text-28 text-2xl font-bold text-black">
                  {startTime}
                </p>
                <p className="event-info md:text-28 text-2xl font-bold text-black">
                  {distance}
                ...
                <p className="text-16 md:text-20 mt-4 ">
                  ...
                  <a
                    href={RegulamentAPV2023}
                    className='font-bold text-black target="_blank" rel="noopener noreferrer"'
                  >
                    regulamentul
                  </a>
                </p>
                <div className="flex items-center">
                  ...
                  <span className="font-bold text-20  mt-4 text-black">
                    Rectoratul UPB
                  </span>
                </div>
              </div>
