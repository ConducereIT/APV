...
export default function Team() {
    return (
      <div id="team" className="max-w-auto mx-10 mt-32 md:mx-60 md:flex text-custom-blue">
        <div>
          ...
          <p className="text-sm md:text-base font-barlow font-bold leading-normal text-custom-green mt-8 md:mt-12">
            „MUNCA ÎN ECHIPĂ ESTE SURSA CE LE PERMITE OAMENILOR OBIȘNUIȚI SĂ ATINGĂ REZULTATE NEOBIȘNUITE.”
          </p>
  
          <p className='text-sm md:text-base font-barlow font-normal leading-normal text-custom-gray mt-4 md:mt-6'>
            Prin intermediul evenimentului “Aleargă Pentru Viață” se distinge munca în echipă depusă de voluntarii Departamentului Sportiv al Ligii Studenților Electroniști, fără de care toate aceste reușite nu ar fi posibile.
          </p>
        ...
        <div>
          <img src={TeamImage} alt="Team Image" className="w-auto md:w-10/12 mr-10  my-20 md:mx-72 md:my-40"/>
        </div>
