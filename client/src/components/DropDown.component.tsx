  ...
  return (
    <>
      <div className="relative  group  my-auto hidden lg:block">
        ...
        >
          <h1 className={`${!isHover ? "text-[#656372]" : "text-[#00B9AE] "}`}>
            {" "}
            {text}{" "}
          </h1>
        </button>
            ...
            >
              {subText &&
                Object.values(subText).map((option: ISubText) => (
                  ...
                  >
                    <h1 className="text-[#656372] hover:text-[#00B9AE] text-lg ">
                      {option.text}
                    </h1>
                  </a>
                ))}
        ...
        <div className="relative min:h-20 ">
          ...
          >
            ...
            >
              <h1
                className={`text-xl ${
                  !isHover ? "text-[#656372]" : "text-[#00B9AE] "
              ...
              {subText &&
                Object.values(subText).map((option: ISubText) => (
                  <a
                    ...
                    className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100"
                  >
                    <h1 className="text-[#656372] hover:text-[#00B9AE] ">
                      {option.text}
                    </h1>
                  </a>
                ))}
