    ...
    <div className="max-w-auto mx-10 mt-28 md:mt-6 md:mx-60 md:flex text-custom-blue">
      <div>
        ...
        <div className="mt-6 md:mt-8 flex items-center">
          ...
          <span className="ml-2 text-sm md:text-base font-barlow font-semibold text-gray-800">Rectoratul UPB</span>
        </div>
      ...
      <div>
        <img src={AboutImage} alt="About Image" className="w-auto md:w-10/12 mr-10  my-20 md:mx-72 md:my-40"/>
      </div>
